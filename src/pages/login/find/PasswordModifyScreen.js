...
import {requestUpdatePassword} from '../../../services/login/Password';
import AlertYesButton from '../../../components/molecules/AlertYesButton';

export default function PasswordModifyScreen({navigation, route}) {
  ...
  const request = () => {
    console.log(route.params.email, route.params.username);
